...
const Card = () => {
  ...
  return (
    ...
    <>
        ...
        >
            <motion.div class="p-0 w-full min-h-[41vh] lg:w-4/5 mx-auto shadow-lg flex flex-col rounded-lg hover:shadow-xl" style={{background:'linear-gradient(90deg, rgb(255,255,255) 0%, rgb(128,128,128) 100%)'}}
            ...
            >
              ...
              >
                ...
                <div class="w-full py-6 px-8 text-gray-800 flex flex-col " style={{background:'linear-gradient(90deg, rgb(255,255,255) 0%, rgb(128,128,128) 100%)'}} >
                  <h3
                    class="text-lg leading-tight truncate mb-2 px-2 py-1"
                    style={{ fontFamily: "Nunito" ,color: '#fff',fontSize:'25px', backgroundColor:"black"}}
